...
try {
  ...
  const labels = page.locator('.transcript [data-slot="basic-tool-tool-title"].agent-title')
  await expect(labels.locator('[data-slot="text-shimmer-char-base"]')).toHaveText(["Skill grill-with-docs", "Skill grilling", "Skill domain-modeling", "Skill MixedCase-Skill", "Skill"])
